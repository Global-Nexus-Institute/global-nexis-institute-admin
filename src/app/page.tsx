...
import { Avatar, Card, Col, Menu, Row, Statistic } from "antd";
import {
  AppstoreOutlined,
  HomeFilled,
  MailOutlined,
...
export default function Home() {
  ...
  return (
    <div className="h-full">
      ...
      <div className="flex pl-10 flex-1 flex-col justify-center ">
        <div className="h-screen md:flex">
          <div className="flex flex-col basis-1/2 bg-gray-600 h-full justify-center">
            <div>Logo</div>
            <div className="flex gap-4 ">
              {user ? (
                <div>
              ...
              <Col span={12}>
                <Card>
                  <Statistic
                    ...
                    value={1123}
                    valueRender={(value) => <Link href="/users">{value}</Link>}
